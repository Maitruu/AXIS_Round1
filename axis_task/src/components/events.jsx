  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 justify-items-center md:grid-cols-2 lg:grid-cols-4 p-5">
        <div className="grid grids-cols-1 justify-items-center rounded-xl m-5 w-2/3 h-3/4 sm:w-3/4 bg-[url('https://www.niet.co.in/blog/wp-content/uploads/2020/09/robotics_Blog-1.jpg')] bg-cover backdrop-blur p-10 ">
          <img
